...
* Align names for counties in bommap2020rough variable
...
p2 <- ggplot(mmap7, aes(x = year)) +
  ...
  labs(x = "Calendar Year", y = "Number of Homicides", size = 3)+
  theme_bw()
ggplotly(p2)
...
# bar chart Percent of Homicides Solved by borogh 2008-2020
...
title <- tags$div(
  HTML('<h3>London Homicides 2008-2020</h3>')
)
